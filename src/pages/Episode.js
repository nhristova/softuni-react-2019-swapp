  ...
  return (
    <main className="episode-main">
      <div className="big-lr-card lr-card">
        <img className="lr-card-photo" src={episode.image} alt={episode.title} width="100%" />
        <div className="lr-card-details">
          <div className="lr-card-title heading-starwars text-highlight ">{episode.title}</div>
          <div className="lr-card-subtitle heading-starwars text-highlight-2">subtitle??</div>
        </div>
      </div>
      <div className="episode-details">
        <div className="episode-synopsis">{episode.openingCrawl}
        </div>
...
export const CharacterLRCard = (character) => {
  return (
    <div className="small-lr-card lr-card">
      <img className="lr-card-photo" src={character.image} alt={character.name} />
      <div className="lr-card-details">
        <div className="lr-card-title"><a className="heading-starwars text-highlight " href={`/character/:${character.id}`}>{character.name}</a></div>
      </div>
    </div>
  )
}
